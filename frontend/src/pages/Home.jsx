...
export default function Home() {
  ...
  useEffect(() => {
  axios.get('https://blogspace-backend-nnz8.onrender.com/api/blogs').then(res => setBlogs(res.data));
  axios.get('https://blogspace-backend-nnz8.onrender.com/api/auth/count').then(res => setUserCount(res.data.count));
}, []);
  ...
  if (window.confirm('Delete this blog?'))
    axios.delete(`https://blogspace-backend-nnz8.onrender.com/api/blogs/${blog._id}`, { 
